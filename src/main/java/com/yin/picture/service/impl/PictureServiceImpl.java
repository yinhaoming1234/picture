...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    private final ThumbServiceByCacheImpl thumbService;
    private final StringRedisTemplate stringRedisTemplate;

    public PictureServiceImpl(FileManager fileManager, UserServiceImpl userService, CosManager cosManager, CosClientConfig cosClientConfig, @Lazy ThumbServiceByCacheImpl thumbService, @Qualifier("stringRedisTemplate") StringRedisTemplate stringRedisTemplate) {
